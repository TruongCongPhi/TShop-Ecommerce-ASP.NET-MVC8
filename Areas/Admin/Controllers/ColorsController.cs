...
namespace TShop.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ColorsController(TshopContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["ColorId"] = new SelectList(_context.Colors.Where(c => c.Levels == null && c.ParentId == null), "ColorId", "ColorName");
        ...
        public async Task<IActionResult> Create([Bind("ColorId,ColorName,ParentId,Levels,ColorHex")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColorId,ColorName,ParentId,Levels,ColorHex")] Color color)
        {
            if (id != color.ColorId)
            {
                return NotFound();
